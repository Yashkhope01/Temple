...
import { getLocalizedContent, supportedLocales } from '@/lib/i18n'

export const dynamic = 'force-dynamic'
export const revalidate = 0

export default async function LocaleEventDetailPage({ params }) {
  ...
  return (
    <section className="bg-beige min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-10">
          <a href={`/${locale}/events`} className="text-temple-orange font-medium hover:underline">← Back to Events</a>
        </div>
      </div>
    </section>
  )
